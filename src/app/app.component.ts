...
import { person, cube, business, home, pricetags, logIn, logOut, cash, barChart, alertCircle, documentText, arrowUndo, time, wallet, list } from 'ionicons/icons';
...
export class AppComponent implements OnInit, OnDestroy {
  ...
  constructor() {
    addIcons({ person, cube, business, home, pricetags, logIn, logOut, cash, barChart, alertCircle, documentText, arrowUndo, time, wallet, list });
  }
